...
impl core::fmt::Debug for AllowedSelfTradePreventionModes {
    ...
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(fmt, "AllowedSelfTradePreventionModes[none(0)={},expire_taker(1)={},expire_maker(2)={},expire_both(3)={},decrement(4)={},transfer(5)={},non_representable(7)={}]",
            self.get_none(),self.get_expire_taker(),self.get_expire_maker(),self.get_expire_both(),self.get_decrement(),self.get_transfer(),self.get_non_representable(),)
    }
}
