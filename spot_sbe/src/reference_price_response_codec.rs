...
pub use decoder::ReferencePriceResponseDecoder;
pub use encoder::ReferencePriceResponseEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 217;
...
pub mod encoder {
    ...
    pub struct ReferencePriceResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ReferencePriceResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ReferencePriceResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> ReferencePriceResponseEncoder<'a> {
        ...
        /// primitive field 'referencePrice'
        ...
        /// - version: 0
        #[inline]
        pub fn reference_price(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct ReferencePriceResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ReferencePriceResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ReferencePriceResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ReferencePriceResponseDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ReferencePriceResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
